...
import me.zyy.reggie.dao.front.OrderDao;
import me.zyy.reggie.entity.*;
import me.zyy.reggie.service.*;
...
public class OrderServiceImpl extends ServiceImpl<OrderDao, Orders> implements OrderService {
    ...
    public void submit(Orders orders) {
        ...
        if (shoppingCartList == null || shoppingCartList.size() == 0) return;

        // userId查询用户信息 orders表需要具体的信息
        User user = userService.getById(userId);

        // 查询地址信息 地址id作为参数已传过来封装在orders
